...
\begin{subnumcases}{\label{def:nodeMisto}}
  i \in \mathbb{R}\label{def:nodeMisto:a} \\
  j \in \mathbb{L}\label{def:nodeMisto:b} \\
  j - i = 2n,\ n \in \mathbb{N}\label{def:nodeMisto:c} \\
  \sigma(j) < \frac{i+j}{2} < \sigma(i)\label{def:nodeMisto:d} \\
  \exists\ i', i'' \in \mathbb{L} : i'(i)\, \wedge\, i(i'')\label{def:nodeMisto:e} \\
  \exists\ j', j'' \in \mathbb{R} : j'(j)\, \wedge\, j(j'')\label{def:nodeMisto:f}
\end{subnumcases}
